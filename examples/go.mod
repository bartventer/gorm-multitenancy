...
require (
	github.com/bartventer/gorm-multitenancy/middleware/echo/v8 v8.7.0
	github.com/bartventer/gorm-multitenancy/middleware/gin/v8 v8.4.0
	github.com/bartventer/gorm-multitenancy/middleware/iris/v8 v8.0.0
	github.com/bartventer/gorm-multitenancy/middleware/nethttp/v8 v8.6.0
	github.com/bartventer/gorm-multitenancy/mysql/v8 v8.7.0
	github.com/bartventer/gorm-multitenancy/postgres/v8 v8.7.0
	github.com/bartventer/gorm-multitenancy/v8 v8.7.0
