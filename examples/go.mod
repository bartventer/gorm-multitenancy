...
require (
	github.com/bartventer/gorm-multitenancy/drivers/postgres/v7 v7.0.0
	github.com/bartventer/gorm-multitenancy/middleware/echo/v7 v7.0.0
...
require (
	github.com/bartventer/gorm-multitenancy/v7 v7.0.0 // indirect
